...
public class ItemCodeDescriptionDrawer : PropertyDrawer
{
    ...
    {
        ScriptableObejctItemList so_itemList;

 so_itemList = AssetDatabase.LoadAssetAtPath("Assets/Scripts/ScriptableObejct Assets/Item/ScriptableObejctItemList.asset", typeof(ScriptableObejctItemList)) as ScriptableObejctItemList;
        //"Assets/Scriptable Object Assets/Item/so_ItemList.asset",typeof(ScriptableObejctItemList)
        List<ItemDeatils> itemDetailsList = so_itemList.itemDeatils;

        ItemDeatils itemDetail = itemDetailsList.Find(x => x.itemCode == itemCode);
